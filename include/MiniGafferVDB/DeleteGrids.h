...
class MINIGAFFERVDB_API DeleteGrids : public GafferScene::SceneElementProcessor
{

	public :

        DeleteGrids(const std::string &name = defaultName<DeleteGrids>() );
		~DeleteGrids();

		IE_CORE_DECLARERUNTIMETYPEDEXTENSION( MiniGafferVDB::DeleteGrids, TypeId::DeleteGridsTypeId, GafferScene::SceneElementProcessor );
