...
namespace MiniGafferVDB
{
	...
	class MINIGAFFERVDB_API CSGLevelSets : public GafferScene::SceneElementProcessor
	{
	...
	public :
		...
		IE_CORE_DECLARERUNTIMETYPEDEXTENSION(MiniGafferVDB::CSGLevelSets, TypeId::CSGGridsTypeId, GafferScene::SceneElementProcessor );
