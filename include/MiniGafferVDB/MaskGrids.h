...
namespace MiniGafferVDB
{
    ...
    class MINIGAFFERVDB_API MaskGrids : public GafferScene::SceneElementProcessor
    {

    public :

        MaskGrids( const std::string &name = defaultName<MaskGrids>() );
        ~MaskGrids();

        IE_CORE_DECLARERUNTIMETYPEDEXTENSION( MiniGafferVDB::MaskGrids, TypeId::MaskGridsTypeId, GafferScene::SceneElementProcessor );
        ...
        Gaffer::FloatPlug *isoPlug();
        const Gaffer::FloatPlug *isoPlug() const;
