...
namespace MiniGafferVDB
{
    ...
    class MINIGAFFERVDB_API IntersectLevelSet : public GafferScene::SceneElementProcessor
    {
    ...
    public :
        ...
        IE_CORE_DECLARERUNTIMETYPEDEXTENSION(MiniGafferVDB::IntersectLevelSet, TypeId::IntersectGridsTypeId, GafferScene::SceneElementProcessor );
