...
namespace MiniGafferVDB
{
    ...
    class MINIGAFFERVDB_API MathOpGrids : public GafferScene::SceneElementProcessor
    {
    ...
    public :
        ...
        IE_CORE_DECLARERUNTIMETYPEDEXTENSION(MiniGafferVDB::MathOpGrids, TypeId::MathOpTypeId, GafferScene::SceneElementProcessor );
